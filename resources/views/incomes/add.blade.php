    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box">
                ...
                <form class="form-horizontal" method="POST" action="{{ action('IncomeController@add') }}">
                    <div class="box-body">
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    @if($isMobile)
                                        <input type="date" class="form-control pull-right" id="income_date" name="income_date" placeholder="dd/mm/aaaa" value="{{ old('income_date') }}">
                                    @else
                                        <input type="text" class="form-control pull-right" id="income_date" name="income_date" placeholder="dd/mm/aaaa" value="{{ old('income_date') }}">
                                    @endif
                                </div>
                            </div>
                            <div class="form-group">
